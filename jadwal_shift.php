...
<body>
    ...
    <div class="shift-container">
        ...
        <div class="calendar-wrapper">
            ...
            <div style="background: #fff3cd; padding: 20px; border-radius: 10px; text-align: center; margin-bottom: 20px;">
                <h3 style="color: #856404; margin: 0 0 10px 0;">📋 Belum Ada Jadwal Shift</h3>
    ...
    <script>
        ...
        console.log('🔧 Initializing shiftsData...');
        const shiftsData = <?= json_encode($shifts_by_date) ?>;
        console.log('📦 shiftsData loaded:', shiftsData);
        console.log('📊 Total shifts:', Object.keys(shiftsData).length);
        
        // Check if script file will load
        console.log('📜 Loading script_jadwal_shift.js...');
    </script>
