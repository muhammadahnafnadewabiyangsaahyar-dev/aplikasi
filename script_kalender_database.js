...
function generateDayView(date) {
    ...
    if (dayTimeColumn && dayContent) {
        ...
        contentHeader.style.height = '50px';
        contentHeader.style.display = 'flex';
        contentHeader.style.alignItems = 'center';
        contentHeader.style.justifyContent = 'center';
        contentHeader.style.fontWeight = 'bold';
        contentHeader.style.backgroundColor = '#f9f9f9';
        contentHeader.style.borderBottom = '2px solid #ddd';
...
function generateYearView(year) {
    ...
    yearHeader.style.gridColumn = '1 / -1';
